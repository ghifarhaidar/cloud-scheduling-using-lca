  ...
  return (
    <>
      ...
      <div className="form-section">
        <h3 className="form-section-title grid-title">📊 League Size (L)</h3>
      ...
      {/* S Parameter */}
      <div className="form-section">
        <h3 className="form-section-title grid-title">🏆 Number of Seasons (S)</h3>
      ...
      {['p_c', 'PSI1', 'PSI2', 'q0'].map((param) => (
        <div className="form-section" key={param}>
          <h3 className="form-section-title grid-title">{param.toUpperCase()}</h3>
          <div className="radio-group">
            <label className="radio-option">
              <input
                type="radio"
